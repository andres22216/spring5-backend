...
INSERT INTO clientes (region_id, nombre, apellido, email, create_at) VALUES(7,'Jade', 'Doe', 'jade.doe@gmail.com', '2018-03-05');

/*creamos algunos usuarios con sus roles */


INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$QPUmSIARE9vqy3E2aY6OlumbhTWNJh9ar.bOa4yUAOAPK/hiW2E2i',1,'Andres', 'Guzman', 'profesor@bolsadeideas.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$feeYHq88Hmi3SaWCi5RzreCwHDoQvHOucptdOpI34Zv.s6fR/26iW',1,'John', 'Doe', 'jhon.doe@bolsadeideas.com');
