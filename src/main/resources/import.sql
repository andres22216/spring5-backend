...
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$i0Ya3lFmtdx1lNqD2rxXP.hjaBZpthGFto0md3lXNcAZkbHviEsbq',1, 'Andres', 'Guzman','profesor@bolsadeideas.com');
INSERT INTO `usuarios` (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$8DZj0DeAamg7mMqwia4xwOboyVcA004onQT72dgtGwUpBqv84Enzu',1, 'John', 'Doe','jhon.doe@bolsadeideas.com');
